...
public class UserServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        switch (action) {
            ...
            case "edit":
                try {
                    edit_User_Store(request,response); //dùng theo cách gọi store
//                    editUser(request, response); dùng theo cách CRUD
                } catch (SQLException throwables) {
                    throwables.printStackTrace();
                }
                break;
    ...
    private void edit_User_Store(HttpServletRequest request, HttpServletResponse response)throws SQLException, ServletException, IOException  {
        int id = Integer.parseInt(request.getParameter("id"));
        String name = request.getParameter("editName");
        String email = request.getParameter("editEmail");
        String country = request.getParameter("editCountry");
        User user = new User(id, name, email, country);
        if (userService.update_User_Store(user)) {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        switch (action) {
            ...
            case "delete":
                try {
                    delete_User_Store(request,response); // dùng theo cách gọi store
//                    deleteUser(request, response); dùng theo cách CRUD
                } catch (SQLException throwables) {
                    throwables.printStackTrace();
                }
                break;
    ...
    private void delete_User_Store(HttpServletRequest request, HttpServletResponse response) throws SQLException, ServletException, IOException {
        int id= Integer.parseInt(request.getParameter("id"));
        if (userService.remove_User_Store(id)) {
            loadList(request, response);
        } else {
    ...
    private void loadList(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        request.setAttribute("listUser", userService.show_All_Store()); //dùng theo cách gọi store
//        request.setAttribute("listUser", userService.selectAllUsers()); dùng theo cách CRUD
        request.getRequestDispatcher("index.jsp").forward(request, response);
    }
}
