...
public class Customer {
    ...
    public Customer(int customer_Id, int type_Customer_Id, String customer_Name, String customer_Birthday, String customer_Id_Card, String customer_Phone, String customer_Email, String customer_Address) {
