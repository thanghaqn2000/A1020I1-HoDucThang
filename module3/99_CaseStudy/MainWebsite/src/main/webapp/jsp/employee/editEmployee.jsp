...
<div class="page-content p-5" id="content">
    ...
    <form method="post" style="width: 500px;margin-right: auto;margin-left: auto">
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-4">
                <label for="inputState2">Choose Position</label>
            ...
            <div class="form-group col-md-4">
                <label for="inputState1">Choose Department</label>
        ...
        <button type="submit" class="btn btn-primary"
                onclick="return confirm('Are you sure you want to add edit employee?')">Update now
        </button>
        <a href="/employee" class="btn btn-danger" style="background: #ff505c">Back to list</a>
    </form>
</div>
