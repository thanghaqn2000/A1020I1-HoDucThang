...
values  (1,3,'Hồ Đức Thắng','2000/09/18','181112345','1234567890','thang@gmail.com','Hội An'),
		...
		(5,1,'Hồ Ngọc Khánh','2000/09/18','181532345','1238267890',null,'Hội An');
...
values -- (1,4,5,1,'2021/03/02','2021/03/05',2000000,10000000)
	   (2,4,2,1,'2021/02/22','2021/03/01',2000000,11000000),
	   (3,3,4,2,'2021/03/29','2021/04/02',1500000,9000000),
	   (4,1,1,3,'2021/02/21','2021/02/25',1000000,80000000);
